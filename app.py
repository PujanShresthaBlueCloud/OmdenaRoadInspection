...
def main():
    ...
    if selected == "Project Information":
        ...
        st.sidebar.markdown("---")
        st.write("Please upload image or video from sidebar for prediction.")
         # Image
        if options == 'Image':
